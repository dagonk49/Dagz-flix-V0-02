...
export function SmartButton({ item, onPlay }) {
  ...
  if (status === 'available') return <Button data-testid="smart-btn-play" onClick={() => onPlay(item)} className={`${cls} bg-white hover:bg-gray-100 text-black shadow-xl shadow-white/10`}><Play className="w-5 h-5 mr-2 fill-current" />LECTURE</Button>;
